...
_MODEL_DIR = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'network')
...
def predict(image_path, dirpath):
    image_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), dirpath+'/'+image_path)
