...
//                null, null);
        searchDrawable.setBounds(0,0, DpUtils.dip2px(context,20), DpUtils.dip2px(context,20));
        clearDrawable.setBounds(0,0, DpUtils.dip2px(context,23), DpUtils.dip2px(context,23));
