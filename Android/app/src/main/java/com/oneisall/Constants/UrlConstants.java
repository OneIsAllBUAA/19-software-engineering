...
//    public static final String WEBSITE_BASE = "http://10.135.240.12:8000";
//    public static final String WEBSITE_BASE = "http://10.135.138.18:8000";
    public static final String WEBSITE_BASE = "http://101.132.71.247:8092";
    private static final String API_BASE= WEBSITE_BASE + "/api";  //local
    public static final String ALL_TASKS = API_BASE + "/all_tasks";
    public static final String RECOMMEND_TASKS = API_BASE + "/recommend_tasks";
    ...
    public static final String UNDO_GRAB = API_BASE + "/undo_grab";
    public static final String FAVORITE_TASK = API_BASE + "/favorite_task";
    public static final String UNDO_FAVORITE = API_BASE + "/undo_favorite";
    ...
    public static final String GET_TASK_USER = API_BASE + "/task_user";
